...
def api_generate():
    ...
    comparison = Comparison(id=comparison_id, melody={"notes": cleaned, "measures": measures}, variation_a=data["variation_a"], variation_b=data["variation_b"], model_version=data["model_version"])
